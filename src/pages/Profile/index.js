      ...
      <View style={styles.content}>
        ...
        <ScrollView style={styles.containerInfos}>
          <View style={styles.infos}>
            ...
            <TextInput value={nome} style={styles.inputs} />
            <Text style={styles.labels}>Cabelo:</Text>
            <TextInput value={hair} style={styles.inputs} />
            <Text style={styles.labels}>Dano capilar:</Text>
            <TextInput value={problemHair} style={styles.inputs} />
            <Text style={styles.labels}>Pele:</Text>
            <TextInput value={skin} style={styles.inputs} />
            <Text style={styles.labels}>Problema da Pele:</Text>
            <TextInput value={problemSkin} style={styles.inputs} />
